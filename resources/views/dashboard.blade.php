...
<div id="app" class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
    ...
    <div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-white shadow-2xl transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 lg:sidebar-animation custom-scrollbar overflow-y-auto">
        ...
        <nav class="px-4 py-6 pb-24 lg:pb-6 space-y-2">
            <!-- Dashboard -->
            <a href="/dashboard" data-route="dashboard" class="nav-item {{ Request::is('dashboard') ? 'active text-white' : 'text-gray-700 hover:bg-blue-50' }} flex items-center space-x-3 px-4 py-3 rounded-xl font-medium">
            ...
            <!-- Classes -->
            <a href="/classes" data-route="classes" class="nav-item {{ Request::is('classes*') ? 'active text-white' : 'text-gray-700 hover:bg-purple-50' }} flex items-center space-x-3 px-4 py-3 rounded-xl font-medium">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Subjects -->
            <a href="/subjects" data-route="subjects" class="nav-item {{ Request::is('subjects*') ? 'active text-white' : 'text-gray-700 hover:bg-yellow-50' }} flex items-center space-x-3 px-4 py-3 rounded-xl font-medium">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                </svg>
            ...
            <!-- Attendance -->
            <a href="/attendance" data-route="attendance" class="nav-item {{ Request::is('attendance*') ? 'active text-white' : 'text-gray-700 hover:bg-indigo-50' }} flex items-center space-x-3 px-4 py-3 rounded-xl font-medium">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Grades -->
            <a href="/grades" data-route="grades" class="nav-item {{ Request::is('grades*') ? 'active text-white' : 'text-gray-700 hover:bg-pink-50' }} flex items-center space-x-3 px-4 py-3 rounded-xl font-medium">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Enrollment Tokens -->
            <a href="/tokens" data-route="tokens" class="nav-item {{ Request::is('tokens*') ? 'active text-white' : 'text-gray-700 hover:bg-teal-50' }} flex items-center space-x-3 px-4 py-3 rounded-xl font-medium">
                <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"></path>
                </svg>
                <span data-i18n="nav.tokens">Enrollment Tokens</span>
            </a>
        </nav>
...
<script>
    ...
    function initializeSidebarNavigation() {
        ...
        window.addEventListener('popstate', () => {
            ...
            SchoolApp.router.navigate(path);
        });
        ...
        bottomNavItems.forEach(item => {
            ...
            if (route) {
                item.addEventListener('click', function() {
                    ...
                    // Navigate using router (SPA style)
                    SchoolApp.router.navigate(route);
